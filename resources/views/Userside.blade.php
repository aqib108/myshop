...
<html lang="en">
   <head>
      ...
      <!--fontawesome css-->
      <link rel="stylesheet" href="{{asset('userasset/css/font-awesome.min.css')}}">
      <!--bootstrap css-->
      <link rel="stylesheet" href="{{asset('userasset/css/bootstrap.min.css')}}">
      <!--animate css-->
      <link rel="stylesheet" href="{{asset('userasset/css/animate-wow.css')}}">
      <!--main css-->
      <link rel="stylesheet" href="{{asset('userasset/css/style.css')}}">
      <link rel="stylesheet" href="{{asset('userasset/css/bootstrap-select.min.css')}}">
      <link rel="stylesheet" href="{{asset('userasset/css/slick.min.css')}}">
      <!--responsive css-->
   ...
   <body>
               ...
               <div class="row">
                  <div class="col-md-4 col-sm-12 left-rs">
                     <div class="navbar-header">
                        ...
                        <a href="index.html" class="navbar-brand"><img src="{{asset('userasset/images/logo.png')}}" alt="" /></a>
                     </div>
                        ...
                        <div class="help-r hidden-xs">
                           <div class="help-box">
                              <ul>
                                 ...
                                 <li> <a href="#"><img class="h-i" src="{{asset('userasset/images/help-icon.png')}}" alt="" /> Help </a> </li>
                              </ul>
                           </div>
                        </div>
         ...
         <div class="modal-dialog">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <ul>
                     <li><a href="#"><img src="{{asset('userasset/images/flag-up-1.png')}}" alt="" /> United States</a></li>
                     <li><a href="#"><img src="{{asset('userasset/images/flag-up-2.png')}}" alt="" /> France </a></li>
                  </ul>
               </div>
            </div>
         </div>
      ...
      <footer>
         ...
         <div class="copyright">
            <div class="container">
               <div class="row">
                  <div class="col-md-8">
                     <p><img width="90" src="{{asset('userasset/images/logo.png')}}" alt="#" style="margin-top: -5px;" /> All Rights Reserved. Company Name © 2018</p>
                  </div>
                  <div class="col-md-4">
                     ...
                     <ul class="right-flag">
                        <li><a href="#"><img src="{{asset('userassetimages/flag.png')}}" alt="" /> <span>Change</span></a></li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <!--main js--> 
      <script src="{{asset('userasset/js/jquery-1.12.4.min.js')}}"></script> 
      <!--bootstrap js--> 
      <script src="{{asset('userasset/js/bootstrap.min.js')}}"></script> 
      <script src="{{asset('userasset/js/bootstrap-select.min.js')}}"></script>
      <script src="{{asset('userasset/js/slick.min.js')}}"></script> 
      <script src="{{asset('userasset/js/wow.min.js')}}"></script>
      <!--custom js--> 
      <script src="{{asset('userasset/js/custom.js')}}"></script>
