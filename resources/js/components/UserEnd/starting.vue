...
<div class="start-free-box">
         <div class="container">
            ...
            <div class="row">
               <div class="main-start-box">
                  <div class="bg_img_left"><img src="userasset/images/bg_img1.png" alt="#" /></div>
                  <div class="container">
                     <div class="buyer-box clearfix">
                        <div class="col-md-6 col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                           <div class="left-buyer">
                              <img class="img-responsive" src="userasset/images/creat_pro.png" alt="#" />
                           </div>
                        </div>
            ...
            <div class="row">
               <div class="bg_img_right"><img src="userasset/images/bg_img1.png" alt="#" /></div>
               <div class="main-start-box">
                  <div class="container">
                     <div class="supplier clearfix">
                        ...
                        <div class="col-md-7 col-sm-6">
                           <div class="right-supplier">
                              <img class="img-responsive" src="userasset/images/supplier-pc-img.png" alt="#" />
                           </div>
                        </div>
                     </div>
                  </div>
